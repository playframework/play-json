...
The [`play.api.libs.json`](api/scala/play/api/libs/json/index.html) package defines an alias for `JsPath`: `__` (double underscore). You can use this if you prefer:
