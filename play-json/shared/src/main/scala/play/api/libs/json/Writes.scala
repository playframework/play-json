...
object OWrites extends PathWrites with ConstraintWrites with ScalaCompatOWrites {
 ...
 * Default Serializers.
 */
object Writes extends PathWrites with ConstraintWrites with DefaultWrites with GeneratedWrites with ScalaCompatWrites {
