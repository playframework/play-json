...
object DerivesFormat {
  case class StandaloneCaseClass(intField: Int) derives OFormat
  sealed trait SomeTrait derives OFormat
  case class SomeCaseClass(stringField: String) extends SomeTrait derives OFormat
  case object SomeCaseObject                    extends SomeTrait derives OFormat
}
...
object DerivesWrites {
  case class StandaloneCaseClass(intField: Int) derives OWrites
  sealed trait SomeTrait derives OWrites
  case class SomeCaseClass(stringField: String) extends SomeTrait derives OWrites
  case object SomeCaseObject                    extends SomeTrait derives OWrites
}
